...
HD_PWD='/nfs/home/t/t_anh/COEN316/Lab3/Code/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log next_address.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source next_address.tcl
