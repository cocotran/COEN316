...
HD_PWD='/nfs/home/t/t_anh/COEN316/Lab3/Code/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log next_address.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source next_address.tcl -notrace
